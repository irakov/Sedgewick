package chap2_4;//2.4.29(page 332)
...
public class MinMaxPQ<T extends Comparable<T>> {
    ...
    public static void main(String[] args) {
        ...
        while (input.hasNext()) {
            ...
            else if (!pq.isEmpty() && item.equals("-")) output.print(pq.deleteMaximum() + " ");
            else if (!pq.isEmpty() && item.equals("+")) output.print(pq.deleteMinimum() + " ");
        }
