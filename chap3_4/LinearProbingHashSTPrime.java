...
public class LinearProbingHashSTPrime<Key extends Comparable<Key>, Value> {
    ...
    public LinearProbingHashSTPrime() {
        this(INITIAL_CAPACITY, INITIAL_LOG_CAPACITY);
    }

    public LinearProbingHashSTPrime(int capacity, int logCapacity) {
    ...
    public static void main(String[] args) {
        ...
        LinearProbingHashSTPrime<String, Integer> hash = new LinearProbingHashSTPrime<String, Integer>();
    ...
    private void resize(int newCapacity) {
        ...
        LinearProbingHashSTPrime<Key, Value> temp = new LinearProbingHashSTPrime<Key, Value>(newCapacity, newLogCapacity);
